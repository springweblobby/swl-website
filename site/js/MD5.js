...
/*Shortened and put into a namespace by
  Stefan Jelner/handgestrickt netzwerk <info@handgestrickt.biz>
  for use in AJAX-applications on 2007/03/02*/
var MD5 = {
	...
	str_md5: function(s) { return MD5.binl2str(MD5.core_md5(MD5.str2binl(s),s.length*MD5.chrsz)); },
	...
	str_hmac_md5: function(key,data) { return MD5.binl2str(MD5.core_hmac_md5(key,data)); },

	//Perform a simple self-test to see if the VM is working
	md5_vm_test: function() { return MD5.hex_md5('abc') == '900150983cd24fb0d6963f7d28e17f72'; },
